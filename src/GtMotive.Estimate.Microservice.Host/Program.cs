...
builder.Services.AddScoped<IListVehiclesUseCase, ListVehiclesUseCase>();
builder.Services.AddScoped<IRentVehicleUserCase, RentVehicleUseCase>();
builder.Services.AddScoped<IReturnVehicleUserCase, ReturnVehicleUseCase>();
